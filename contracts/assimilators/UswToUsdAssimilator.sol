...
contract UswToUsdAssimilator is IAssimilator {
    using ABDKMath64x64 for int128;
    using ABDKMath64x64 for uint256;

    using SafeMath for uint256;

    IERC20 private constant cadc = IERC20(0xa10FAa75589bf01AF220b2D6aCb91785129443f0);

    IERC20 private constant usdc = IERC20(0x11bbB41B3E8baf7f75773DB7428d5AcEe25FEC75);

    IOracleTwap public constant oracle = IOracleTwap(0x6DFce9a9E95c6E37AA0c26E2E6E4B80D98cb8d59);
