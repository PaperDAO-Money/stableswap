...
The deployed contract addresses can be found [here](/scripts/10001/).

### Key Differences

The following changes are made on PaperDAO Smart Contracts.

- Addresses of ERC20 tokens updated according to the ETH POW chain.
- Updated assimilator contract names
